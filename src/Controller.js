...
const Controller = (props) => {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={mouse.innerCircle === "" ? "inner-circle" : "inner-circle down"}
          draggable="false"
        ...
        ></div>
        <div className="menu-btn" draggable="false" onClick={(e) => {
          e.stopPropagation();
        ...
        <div className="backward" draggable="false">
          <img
            ...
            draggable="false"
            onClick={() => prevSong(songsList)}
          />
        </div>
        <div className="play-pause" draggable="false" onClick={() => play(songsList)}>
          <img
